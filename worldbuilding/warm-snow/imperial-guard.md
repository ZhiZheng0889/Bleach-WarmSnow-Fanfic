...
Police Warm Snow outbreaks, protect clan interests, and control movement between districts. Split loyalties make them both tools of oppression and potential allies.

## Structure
- **Outer Gates Command**: patrols Rukongai walls, issues travel permits, collects tolls. Often bribed by Clan Yue riverwardens.
...
- **Inner Wall**: captain reports to Clan Long; enforces conscription and suppresses protests.
- **Archivist Liaison**: Bai scribes embed to censor reports; creates friction with rank-and-file who see Hollow risks ignored.

## Hooks for scenes
- Guard raid backfires when Seal Lanterns tag Hellborne mimics, triggering Chain pulls to Hell.
- Whitewall line holds against Warm Snow blizzard until Thunderfury disciples short out the sigils.
- Oath Halberd pins a deserter; Urahara slips a counter-sigil to spoof loyalty.
