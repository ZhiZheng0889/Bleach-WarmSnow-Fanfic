...
Hub page for Hellborne weapon/relic notes. Detailed content now lives in split files to keep things readable.

- Core system (rarity, rolls, distilling, sample names): [hellborne-mechanics.md](hellborne-mechanics.md)
