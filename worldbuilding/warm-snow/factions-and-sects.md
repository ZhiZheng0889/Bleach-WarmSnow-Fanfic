...
## Five Great Clans
The wiki home page describes Bi-an’s crusade as being “against the Five Great Clans”. Details for each clan still need to be verified and summarized.
...
The wiki home page includes a “favorite sect” poll that lists these sect names:
...
### What “sect” means (usable definition)
In the wiki’s structure, sects are effectively **statue choices** that:
...
- In a Bleach crossover, sects can map cleanly to **schools** or **lineages** (like Kidō traditions, clan techniques, or Hollow cults).

## Other likely factions to capture next
From the wiki’s navigation and page list, these appear to exist as categories or groups worth extracting later:
